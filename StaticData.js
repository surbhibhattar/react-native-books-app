export const booksList = [
  ...
  },
  {
    ...
    icon: require("./assets/kite_runner.jpg"),
  ...
  },
  {
    ...
    author: "J.K. Rowling",
    icon: require("./assets/harry_potter.jpg"),
  ...
  },
  {
    ...
    icon: require("./assets/slaughterhouse_five.jpg"),
  ...
  },
  {
    ...
    author: "Harper Lee",
    icon: require("./assets/to_kill_a_mocking_bird.jpg"),
  ...
  },
  {
    ...
    icon: require("./assets/Jane_Eyre.jpg"),
    description: `Orphaned as a child, Jane has felt an outcast her whole young life. Her courage is tested once again when she arrives at Thornfield Hall, where she has been hired by the brooding, proud Edward Rochester to care for his ward Adèle. Jane finds herself drawn to his troubled yet kind spirit. She falls in love. But there is a terrifying secret inside the gloomy, forbidding Thornfield Hall. Is Rochester hiding from Jane? Will Jane be left heartbroken and exiled once again?`,
  },
  {
    id: 8,
    name: "The Great Gatsby",
    author: "F. Scott Fitzgerald",
    icon: require("./assets/the_great_gatsby.jpg"),
  ...
  },
  {
    ...
    author: "J. D. Salinger",
    icon: require("./assets/the_catcher_in_the_rye.jpg"),
  ...
  },
  {
    ...
    author: "Jane Austen",
    icon: require("./assets/pride_and_prejudice.jpg"),
